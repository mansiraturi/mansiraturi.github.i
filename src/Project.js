            ...
            <div className="row">
                ...
                <div className="col__4">
                    <div className="project__box pointer relative">
                        ...
                        <a href="https://github.com/mansiraturi/LeafDisease" target="_blank" className="project__btn"> View Project</a>
                        </div>
                    </div>
                </div>
                ...
                <div className="col__4">
                    <div className="project__box pointer relative">
                        ...
                        <a href="https://github.com/mansiraturi/MANGER" target="_blank" className="project__btn"> View Project</a>
                        </div>
                    </div>
                </div>
            ...
            <div className="row">
                ...
                <div className="col__4">
                    <div className="project__box pointer relative">
                        ...
                        <a href="https://github.com/mansiraturi/BookBea" target="_blank" className="project__btn"> View Project</a>
                        </div>
                    </div>
                </div>
                ...
                <div className="col__4">
                    <div className="project__box pointer relative">
                        ...
                        <a href="https://github.com/mansiraturi/MalwareDetection" target="_blank" className="project__btn"> View Project</a>
                        </div>
                    </div>
                </div>
                ...
                <div className="col__4">
                    <div className="project__box pointer relative">
                        ...
                        <a href="https://github.com/mansiraturi/KnockDetection" target="_blank" className="project__btn"> View Project</a>
                        </div>
                    </div>
                </div>
